#ifndef _ROS_rbiz_autorace_msgs_SensorStateLevelCrossing_h
#define _ROS_rbiz_autorace_msgs_SensorStateLevelCrossing_h
...
namespace rbiz_autorace_msgs
{
  ...
  class SensorStateLevelCrossing : public ros::Msg
  {
    public:
      ...
      typedef int32_t _level_status_type;
      _level_status_type level_status;
      typedef float _battery_type;
      _battery_type battery;

    SensorStateLevelCrossing():
      stamp(),
      sensor_distance(),
      elapsed_time(0),
      is_started(),
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_vehicle_state.base >> (8 * 3)) & 0xFF;
      ...
      u_level_status.real = this->level_status;
      *(outbuffer + offset + 0) = (u_level_status.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_level_status.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_level_status.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_level_status.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->level_status);
      union {
        float real;
        uint32_t base;
      } u_battery;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_level_status.base = 0;
      u_level_status.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_level_status.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_level_status.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_level_status.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->level_status = u_level_status.real;
      offset += sizeof(this->level_status);
      union {
        float real;
        uint32_t base;
    ...
    const char * getType(){ return "rbiz_autorace_msgs/SensorStateLevelCrossing"; };
    const char * getMD5(){ return "460faa7542d0236fdb251d2fdd08cfe4"; };
