...
void setup(){
  ...
  myOLLO.begin(4);//DMS Module must be connected at port 4.
...
void loop(){
  ...
  int sensor4_distance = myOLLO.read(4);
...
// //  delay(60);
  Serial.print("DMS Sensor 4 ADC Value = ");
  Serial.println(sensor4_distance); //read ADC value from OLLO port 4

  Serial.print("DMS Sensor 0 DADC Value = ");
  Serial.println(analogRead(A0)); //read ADC value from OLLO port 4
  Serial.print("DMS Sensor 1 DADC Value = ");
  Serial.println(analogRead(1)); //read ADC value from OLLO port 4
